...
public abstract class Clause {
    ...
    protected abstract Memo match(String input, MemoRef memoRef);
    ...
    protected static Memo lookUpSubClauseMemo(String input, MemoRef parentMemoRef, MemoRef subClauseMemoRef) {
        ...
        var subClauseMemo = subClauseMemoRef.clause.startPosToMemo.get(subClauseMemoRef.startPos);
    ...
    public static void matchMemoized(String input, MemoRef memoRef, Set<MemoRef> activeSet) {
        ...
        if (oldMemo == null || oldMemo.len < newMemo.len) {
            ...
            // a match now (len >= 0) but the new match is longer than the old match (match length must increase
